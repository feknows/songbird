-- SongBird - Setup completo (schema + RLS + admin)
...
-- ========== ROW LEVEL SECURITY ==========
-- A chave anon �? p�blica (exposta no HTML), ent�?o RLS com pol�­ticas
...
-- Usu�?rios: s�? p�?de SELECT (login) e UPDATE pr�?pria senha
...
-- Produtos/faixas/m�?dulos: CRUD completo (admin usa pelo frontend)
...
-- Leads: CRUD completo (coleta pelo scraper + visualizaç�?o)
CREATE POLICY "leads_all" ON leads FOR ALL USING (true) WITH CHECK (true);

-- ========== USUÁRIO ADMIN ==========
INSERT INTO usuarios (nome, senha, permissao)
VALUES ('felipe', '80799333a52c240c1eea02f3379d876679518d72f5d393d0bffa2ca7e610809c', 'admin')
